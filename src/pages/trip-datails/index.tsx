...
import { CreateActivityModal } from "./creat-activity-modal";
        ...
        <div className="flex-1 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-lime-300 text-lime-950 rounded-lg px-20 py-3 font-medium flex items-center gap-2 hover:bg-lime-400"
            >
